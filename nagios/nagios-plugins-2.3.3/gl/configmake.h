...
#define RUNSTATEDIR "/usr/local/nagios/var/run"
...
#define LISPDIR "/usr/local/nagios/share/emacs/site-lisp"
...
#define PKGLIBEXECDIR "/usr/local/nagios/libexec/nagios-plugins"
